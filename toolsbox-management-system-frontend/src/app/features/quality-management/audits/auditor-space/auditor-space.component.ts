...
@Component({
  selector: 'app-auditor-space',
  templateUrl: './auditor-space.component.html',
  styleUrls: ['./auditor-space.component.css']
})
export class AuditorSpaceComponent implements OnInit {
  // List of audits
  listAudits: any;
...
@Output() reloadEvent = new EventEmitter();
  ...
  reloadData() {
    this.listAudits = this.getAuditsByUser();
  }
  /** Get all audits */
  getAuditsByUser() {
    this.genericService.getGenericByAuthPage('/audits/principal-auditor', this.username, this.selectedPage, this.item)
      .subscribe(
        data => {
