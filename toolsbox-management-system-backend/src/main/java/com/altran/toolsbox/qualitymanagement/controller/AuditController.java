...
public class AuditController {
	 ...
	 * 
	 * @param auditService the service interface of audit
	 */
	@Autowired
	...
	public MappingJacksonValue getAllAudits() {
		...
		SimpleBeanPropertyFilter auditFilter = SimpleBeanPropertyFilter.filterOutAllExcept(ID, AUDITREPORT, RISKS,
				DURATION, ISSUES, AUDITED, PROCESSIMPACTS, AUDITTHEME);
...
//	@PreAuthorize("hasAnyAuthority('" + SHOWESPACEAUDITEUR + "')")
	 ...
	 * other exception
	 * 
	 * @param audit the new activity object with the new values
	 * @param id    the id of the audit
	 ...
	 * 
	 * @param id the of the deleted audit
